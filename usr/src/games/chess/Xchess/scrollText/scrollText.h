 ...
 * Date: 2025-11-19
 */
#ifndef _GAMES_CHESS_XCHESS_SCROLLTEXT_SCROLLTEXT_H_
#define _GAMES_CHESS_XCHESS_SCROLLTEXT_SCROLLTEXT_H_
...
#endif /* _GAMES_CHESS_XCHESS_SCROLLTEXT_SCROLLTEXT_H_ */
