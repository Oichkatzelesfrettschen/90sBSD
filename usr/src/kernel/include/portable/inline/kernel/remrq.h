 ...
 * Date: 2025-11-19
 */
#ifndef _KERNEL_INCLUDE_PORTABLE_INLINE_KERNEL_REMRQ_H_
#define _KERNEL_INCLUDE_PORTABLE_INLINE_KERNEL_REMRQ_H_
...
#endif /* _KERNEL_INCLUDE_PORTABLE_INLINE_KERNEL_REMRQ_H_ */
